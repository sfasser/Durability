...
public class DBManager {
    ...
    public void insert(String name, String date) {
        ...
        contentValue.put(DatabaseHandler.KEY_DATE, date);
        database.insert(DatabaseHandler.TABLE_PRODUCTS, null, contentValue);
    }

    public Cursor fetch() {
        String[] columns = new String[] { DatabaseHandler.KEY_ID, DatabaseHandler.KEY_NAME, DatabaseHandler.KEY_DATE };
        Cursor cursor = database.query(DatabaseHandler.TABLE_PRODUCTS, columns, null, null, null, null, null);
        if (cursor != null) {
            cursor.moveToFirst();
        }
        return cursor;
    ...
    public int update(long _id, String name, String date) {
        ...
        contentValues.put(DatabaseHandler.KEY_DATE, date);
